...
/*RevokeCredential swagger:route DELETE /insurance/credential/{publicKey} insurance revokeCredential

Revoke a health credential

This service revokes a health credential in the credential revocation list(SaludChain) providing a publicKey
